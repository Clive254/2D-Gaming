...
Fixed issues in some examples
Added new examples


v 0.6.2
Fixed asynchronous response not returned in some cases
...
Added support for multiple transport layers : engine.io and sockjs are supported
Fixed issue with data not returned in some cases
